...
export default function EmployeeEdit({ 
    ...
    const { data, setData, put, processing, errors } = useForm<EmployeeFormData>({
        ...
        status_kawin: employee.status_kawin,
    ...
    return (
        <AppShell>
            <Head title={`Edit ${employee.nama} - Data Pegawai`} />
            ...
            <div className="space-y-6">
                ...
                <div>
                    ...
                    <h1 className="text-3xl font-bold">✏️ Edit Data Pegawai</h1>
                    <p className="text-gray-600 dark:text-gray-400">
                        Perbarui informasi pegawai {employee.nama}
                    </p>
                </div>
